#!/usr/bin/env python3
"""Render Week 3 Day 1 teaching docs to PDF via headless Chrome + institute branding."""
...
def find_chrome() -> str:
    ...
    raise SystemExit(
        ...
        "  .venv-docs/bin/python docs/week-03-day-01/build_editable_pptx.py\n"
    )
...
def main() -> int:
    ...
    jobs.append((SLIDES.joinpath("week-03-day-01.html").as_uri(), PDF_DIR / "week-03-day-01-slides.pdf"))
    ...
    md_jobs = [
        (SLIDES / "week-03-day-01-notes.md", "Presenter notes"),
        ...
        (ROOT / "README.md", "Week 3 kit index"),
    ]
    ...
    slides_pptx = PDF_DIR / "week-03-day-01-slides.pptx"
